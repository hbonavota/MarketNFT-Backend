    ...
    try {
      ...
      ResultPrice = arrPrice.reduce(reducerP);
        ...
        let preference = {
            ...
            back_urls: {
              success: "https://project-nft-s-frontend.vercel.app//success",
              failure: "https://project-nft-s-frontend.vercel.app//failure",
              pending: "https://project-nft-s-frontend.vercel.app//pending"
          },
